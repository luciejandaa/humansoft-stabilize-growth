...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 rounded-full active:scale-[0.97] active:duration-75",
  {
    variants: {
      variant: {
        default: "bg-foreground text-background hover:bg-[hsl(var(--primary-deep))] hover:shadow-[0_10px_30px_-10px_hsl(0_0%_4%/0.35)] hover:-translate-y-0.5 active:translate-y-0",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 active:bg-destructive/80",
        outline: "border border-foreground/25 bg-transparent text-foreground hover:bg-foreground hover:text-background hover:border-foreground active:bg-foreground/90 active:text-background",
        ...
        link: "text-[hsl(var(--primary-deep))] underline-offset-4 hover:underline rounded-none active:opacity-70",
        hero: "bg-foreground text-background text-base px-8 py-4 h-auto hover:bg-[hsl(var(--primary-deep))] hover:shadow-[0_20px_50px_-15px_hsl(0_0%_4%/0.4)] hover:-translate-y-1 active:translate-y-0",
        ...
        /* Lime CTA — electric energy, black ink, subtle black offset shadow */
